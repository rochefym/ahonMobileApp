...
export class HomePage {
  url: string = 'http://192.168.1.3:8000/api/stream';
            ...
            function createButtons() {
              try {
                ...
                streamBtn.addEventListener('click', function(e) {
                  ...
                  window.location.href = 'http://192.168.1.3:8000/api/stream';
                });
                ...
                yoloBtn.addEventListener('click', function(e) {
                  ...
                  window.location.href = 'http://192.168.1.3:8000/api/yolo-stream';
                });
  ...
  openLiveStream() {
    this.url = 'http://192.168.1.3:8000/api/stream';
    this.openBrowser();
  }

  openYoloStream() {
    this.url = 'http://192.168.1.3:8000/api/yolo-stream';
    this.openBrowser();
  }
}